  ...
  async function handleLogin(event) {
    ...
    try {
      ...
      if (error || !data.session) {
        setErrorMessage(
          "E-mail ou palavra-passe inválidos. Verifique os dados e tente novamente."
        );
        return;
      }
  ...
  return (
    <main className="min-h-[100dvh] overflow-hidden bg-black text-white">
      <section className="relative flex min-h-[100dvh] flex-col justify-center px-6 py-10 sm:px-10 sm:py-12 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(420px,0.9fr)] lg:px-14 lg:py-8 xl:px-20">
        ...
        <aside className="relative z-10 mx-auto flex w-full max-w-[390px] flex-col items-center justify-start text-center lg:mx-0 lg:min-h-[calc(100vh-4rem)] lg:max-w-none lg:items-start lg:justify-between lg:py-4 lg:text-left">
          <div>
            <BrandLogo />
            ...
            <div className="mt-12 max-w-xl sm:mt-16 lg:mt-24 xl:mt-28">
              ...
              <div className="mt-7 flex items-center justify-center gap-4 sm:mt-9 lg:justify-start">
        ...
        <section className="relative z-10 mx-auto flex w-full max-w-[390px] items-center justify-center pb-4 pt-7 sm:max-w-md sm:pt-8 lg:mx-0 lg:min-h-[calc(100vh-4rem)] lg:max-w-none lg:justify-center lg:py-4">
          <div className="w-full max-w-[390px] sm:max-w-md lg:-translate-x-6 xl:-translate-x-10">
            ...
            <div className="mt-5 rounded-2xl border border-[#beaf87]/12 bg-[#080808]/80 p-4 text-sm text-white/62 lg:hidden">
